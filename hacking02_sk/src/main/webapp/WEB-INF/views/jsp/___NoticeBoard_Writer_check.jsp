...
//			);
	...
	<div class="container">
		...
		<div style="width:100%">
			<table class="table table-bordered"> 
				...
				<tr>
					<th style="background-color:#fafafa;white-space: pre;">제목</th>
					<td><%=mysubject%></td>
				...
				<tr>
					...
					<td colspan="3" style="white-space: pre;"><%=mytext%></td>  
				</tr>
				</tbody>
			</table>
	...
	<script>
			...
			if( typeof cur_user_id !== 'undefined' && MyLibrary.f_check_valid(cur_user_id) && (!cur_user_id.match(/^(root|(admin|manager)[0-9]?)$/)) && cur_user_id !== '<%=myid%>' ) {
				inputmyid_수정.remove(); 
			}
			...
			if(typeof(inputmyid_수정) !== 'undefined' && MyLibrary.f_check_valid(inputmyid_수정)){
